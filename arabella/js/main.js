...
if(mainSlider.length>0){
	mainSlider.slick({
		...
		// appendArrows:$('.main__slider-arrows'),
...
$('.form__consultation .check').click(function(event) {
	$('.form__consultation button.disable').toggleClass('not-disable');
});
